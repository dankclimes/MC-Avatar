...
//            ItemMapBase, MapColor, WorldInfo, World, 
//            EntityPlayer, MathHelper, MapData, ItemStack, 
//            Chunk, Material, Entity, Block, 
//            WorldProvider
    ...
    public void func_28011_a(World world, Entity entity, MapData mapdata)
    {
        ...
        for(int k1 = (l - j1) + 1; k1 < l + j1; k1++)
        {
            ...
            for(int j2 = i1 - j1 - 1; j2 < i1 + j1; j2++)
            {
                        ...
                        for(int l5 = 0; l5 < i; l5++)
                        {
                            ...
                            if(j6 > 1)
                            {
                                ...
                                do
                                {
                                    ...
                                    if(j6 > 0 && l6 > 0 && Block.blocksList[l6].blockMaterial.field_28129_A == MapColor.field_28212_b)
                                    {
                                        flag1 = false;
                                    }
                                    if(!flag1)
                ...
                if(i6 > 0)
                {
                    MapColor mapcolor = Block.blocksList[i6].blockMaterial.field_28129_A;
