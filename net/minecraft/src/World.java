    ...
    implements IBlockAccess
{
    ...
    public World(ISaveHandler isavehandler, String s, long l, WorldProvider worldprovider)
    {
        ...
        {
            worldProvider = WorldProvider.func_4101_a(-1);
        } else
        {
            worldProvider = WorldProvider.func_4101_a(0);
        }
        boolean flag = false;
        if(worldInfo == null)
        {
    ...
    protected void updateBlocksAndPlayCaveSounds()
    {
        ...
        for(Iterator iterator = positionsToUpdate.iterator(); iterator.hasNext();)
        {
            ...
            if(soundCounter == 0)
            {
                ...
                l2 += k;
                l3 += i1;
                if(l5 == 0 && func_28104_m(l2, l4, l3) <= rand.nextInt(8) && getSavedLightValue(EnumSkyBlock.Sky, l2, l4, l3) <= 0)
                {
    ...
    {
        field_28108_z.func_28184_a(s, mapdatabase);
    }
