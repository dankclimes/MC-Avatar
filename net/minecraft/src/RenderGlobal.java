...
//            EntityNoteFX, BlockLeaves, Vec3D, EntityBubbleFX, 
//            StepSound, RenderBlocks, OpenGlCapsChecker, WorldRenderer, 
//            EffectRenderer, AxisAlignedBB, World, EntityLavaFX, 
//            GLAllocation, EntityFootStepFX, Item, EntityPlayer, 
//            EntityExplodeFX, EntityReddustFX, MathHelper, EnumMovingObjectType, 
//            RenderEngine, EntitySorter, EntityHeartFX, GameSettings, 
//            TileEntityRenderer, EntityLiving, RenderSorter, EntitySnowShovelFX, 
//            Tessellator, EntityPortalFX, TileEntity, EntitySlimeFX, 
//            IWorldAccess, EntityRenderer, EntityFlameFX, ImageBufferDownload, 
//            Entity, EntitySplashFX, RenderHelper, RenderList, 
//            RenderManager, ItemRecord, GuiIngame, Block, 
//            MovingObjectPosition, WorldProvider, EntitySmokeFX, ICamera, 
//            SoundManager, ItemStack
    ...
    implements IWorldAccess
{
    ...
    public void renderSky(float f)
    {
        ...
        if(af != null)
        {
            ...
            tessellator.renderWithRotationOrOffset(6);
    ...
    public void renderClouds(float f)
    {
        ...
        d -= j * 2048 /*GL_EXP*/;
        d1 -= k * 2048 /*GL_EXP*/;
        float f9 = (worldObj.worldProvider.func_28111_d() - f1) + 0.33F;
    ...
    public void renderCloudsFancy(float f)
    {
        ...
        float f4 = (worldObj.worldProvider.func_28111_d() - f1) + 0.33F;
    ...
    {
        Tessellator tessellator = Tessellator.instance;
        tessellator.renderWithRotationOrOffset(3);
        ...
        tessellator.addVertex(axisalignedbb.minX, axisalignedbb.maxY, axisalignedbb.minZ);
        tessellator.draw();
        tessellator.renderWithRotationOrOffset(1);
        tessellator.addVertex(axisalignedbb.minX, axisalignedbb.minY, axisalignedbb.minZ);
        tessellator.addVertex(axisalignedbb.minX, axisalignedbb.maxY, axisalignedbb.minZ);
        tessellator.addVertex(axisalignedbb.maxX, axisalignedbb.minY, axisalignedbb.minZ);
        tessellator.addVertex(axisalignedbb.maxX, axisalignedbb.maxY, axisalignedbb.minZ);
