...
//            GuiScreen, RenderItem, GuiSlotStatsItem, StatCollector, 
//            GuiSlotStatsBlock, Item, GuiSlotStats, RenderEngine, 
//            GuiButton, GuiSlot, StringTranslate, Tessellator, 
//            GuiSlotStatsGeneral, RenderHelper, StatFileWriter, FontRenderer
...
public class GuiStats extends GuiScreen
{
    ...
    private void func_27138_c(int i, int j, int k)
    {
        ...
        GL11.glPopMatrix();
        field_27153_j.func_27003_a(fontRenderer, mc.renderEngine, k, 0, Item.itemsList[k].getIconFromDamage(0), i + 2, j + 2);
