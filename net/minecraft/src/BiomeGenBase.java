...
//            WorldGenBigTree, EnumCreatureType, BiomeGenForest, BiomeGenSky, 
//            BiomeGenHell, BiomeGenSwamp, Block, EntitySlime, 
//            EntityZombie, EntityPig, BlockGrass, EntityChicken, 
//            EntitySquid, WorldGenTrees, BiomeGenRainforest, WorldGenerator
...
public class BiomeGenBase
{
    ...
    public static final BiomeGenBase field_28057_m = (new BiomeGenSky()).setColor(0x8080ff).setBiomeName("Sky").setDisableRain();
