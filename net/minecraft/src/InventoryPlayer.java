    ...
    implements IInventory
{
    ...
    public void decrementAnimations()
    {
        for(int i = 0; i < mainInventory.length; i++)
        {
            if(mainInventory[i] != null)
            {
                mainInventory[i].func_28153_a(player.worldObj, player, i, currentItem == i);
            }
        }
    ...
    public boolean addItemStackToInventory(ItemStack itemstack)
    {
        ...
        if(j >= 0)
        {
            mainInventory[j] = ItemStack.func_30010_b(itemstack);
    ...
    public boolean func_28018_c(ItemStack itemstack)
    {
        ...
        {
            if(armorInventory[i] != null && armorInventory[i].func_28154_b(itemstack))
            {
                return true;
            }
        }
        ...
        for(int j = 0; j < mainInventory.length; j++)
        {
            if(mainInventory[j] != null && mainInventory[j].func_28154_b(itemstack))
            {
                return true;
            }
        }
