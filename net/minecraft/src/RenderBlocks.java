...
//            Vec3D, MathHelper, ModelBed, BlockDoor, 
//            Material, Tessellator, BlockRail, EntityRenderer, 
//            BlockFluid, BlockRedstoneWire, Block, BlockBed, 
//            BlockRedstoneRepeater, IBlockAccess, BlockFire, World
...
public class RenderBlocks
{
    ...
    private boolean renderBlockBed(Block block, int i, int j, int k)
    {
        ...
        int ff17 = block.getBlockTexture(blockAccess, i, j, k, 0);
        int j1 = (ff17 & 0xf) << 4;
        int k1 = ff17 & 0xf0;
