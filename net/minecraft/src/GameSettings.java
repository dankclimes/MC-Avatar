...
//            StatCollector, EnumOptionsMappingHelper, EnumOptions, RenderEngine, 
//            RenderGlobal, StringTranslate, KeyBinding, SoundManager
...
public class GameSettings
{
    ...
    public String getKeyBinding(EnumOptions enumoptions)
    {
        ...
        if(enumoptions == EnumOptions.LIMIT_FRAMERATE)
        {
            return (new StringBuilder()).append(s).append(StatCollector.translateToLocal(field_30006_M[limitFramerate])).toString();
        }
        if(enumoptions == EnumOptions.GRAPHICS)
        {
            if(fancyGraphics)
