...
//            RenderItem, EntityGhast, Render, EntityCow, 
//            EntitySnowball, EntityLightningBolt, EntityFireball, EntitySpider, 
//            RenderSnowball, EntitySheep, RenderPlayer, RenderPainting, 
//            ModelSheep1, ModelPig, ModelZombie, RenderSquid, 
//            World, RenderBoat, ModelBiped, EntitySkeleton, 
//            EntityBoat, EntityCreeper, EntityWolf, Item, 
//            RenderFallingSand, EntityPlayer, RenderLiving, ModelCow, 
//            EntityItem, MathHelper, RenderChicken, EntityFallingSand, 
//            RenderFireball, ModelSkeleton, RenderCreeper, EntityLiving, 
//            EntityFish, RenderEntity, RenderArrow, RenderPig, 
//            RenderSlime, ModelSheep2, ModelWolf, ModelSlime, 
//            EntityGiantZombie, RenderTNTPrimed, RenderLightningBolt, RenderFish, 
//            RenderGhast, EntityPainting, EntityTNTPrimed, EntityArrow, 
//            Entity, RenderMinecart, ModelChicken, RenderBiped, 
//            Block, EntitySlime, EntityZombie, RenderCow, 
//            EntityEgg, RenderWolf, EntityPig, ModelSquid, 
//            EntityChicken, EntitySquid, RenderSheep, RenderGiantZombie, 
//            EntityMinecart, RenderSpider, FontRenderer, RenderEngine, 
...
public class RenderManager
{
    ...
    private RenderManager()
    {
        ...
        entityRenderMap.put(net.minecraft.src.EntityExample.class,new RenderExample(new ModelExample(),0.7F));
