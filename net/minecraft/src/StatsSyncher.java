...
//            Session, ThreadStatSyncherSend, ThreadStatSyncherReceive, StatFileWriter
...
public class StatsSyncher
{
    ...
    private void func_27410_a(Map map, File file, File file1, File file2) throws IOException
    {
    ...
    static void func_27412_a(StatsSyncher statssyncher, Map map, File file, File file1, File file2) throws IOException
    {
